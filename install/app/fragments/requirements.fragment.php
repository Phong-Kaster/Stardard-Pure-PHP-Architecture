            ...
            <div class="subsection">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="fw-700">/app/config/db.config.php</span></td>
                            <td class="status">
                        ...
                        <tr>
                            <td><span class="fw-700">/app/config/config.php</span></td>
                            <td class="status">
                        ...
                        <tr>
                            <?php 
                                if (!file_exists(ROOTPATH."/assets/uploads/")) {
                                    @mkdir(ROOTPATH."/assets/uploads/", "0777", true);
                                }
                            ?>
                            <td><span class="fw-700">/assets/uploads/</span></td>
                            <td class="status">
                                <?php if (is_writeable(ROOTPATH."/assets/uploads/")): ?>
                                    <span class="mdi mdi-check-circle color-green"></span>
                                <?php else: ?>
                                    <span class="mdi mdi-close-circle color-red"></span>
                                    <?php $installable = false; ?>
                        ...
                        <tr>
                            <?php 
                                if (!file_exists(ROOTPATH."/app/sessions/")) {
                                    @mkdir(ROOTPATH."/app/sessions/", "0777", true);
                                }
                            ?>
                            <td><span class="fw-700">/app/sessions/</span></td>
                            <td class="status">
                                <?php if (is_writeable(ROOTPATH."/app/sessions/")): ?>
                                    <span class="mdi mdi-check-circle color-green"></span>
                                <?php else: ?>
                                    <span class="mdi mdi-close-circle color-red"></span>
                                    <?php $installable = false; ?>
                        ...
                        <tr>
                            <td><span class="fw-700">/app/inc/</span></td>
                            <td class="status">
                                <?php if (is_writeable(ROOTPATH."/app/inc/")): ?>
                                    <span class="mdi mdi-check-circle color-green"></span>
                                <?php else: ?>
                                    <span class="mdi mdi-close-circle color-red"></span>
                                    <?php $installable = false; ?>
